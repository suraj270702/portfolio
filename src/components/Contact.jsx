...
const Contact = () => {
  return (
    <>
      <div className="w-full md:w-[820px] h-full md:h-[700px] px-4 md:px-10 md:py-6 py-4 bg-[#FFF] rounded-[20px] shadow-sm ">
        <div>
          <div className="flex gap-3 items-center">
            <span className="text-[#0B0909] text-[20px] md:text-[40px] font-[500] leading-[20px] md:leading-[40px]">
              Contact
            </span>
            <svg
            ...
            >
              <path
                d="M1 1L253 3"
                stroke="url(#paint0_linear_104_465)"
                stroke-width="2"
                stroke-linecap="round"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_104_465"
                  x1="127"
                  y1="1"
                  x2="127"
                  y2="3"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-6">
            <div className="w-full md:w-[333px] h-full md:h-[150px] bg-[#FFEED9] rounded-[8px] px-2 md:px-4 md:py-6 py-2">
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[16px] leading-[20px] md:leading-[40px] font-[500] text-[#000]">
                    Phone :-
                  </span>
                </div>
                <span className="text-[16px] leading-[20px] md:leading-[40px] font-[500] text-[#000] md:ml-10">
                  8369930667
                </span>
              </div>
            </div>
            <div className="w-full md:w-[333px] h-full md:h-[150px] bg-[#F2F7FC] rounded-[8px] px-2 md:px-4 md:py-6 py-2">
              <div>
                <div className="flex items-center gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
